						...
						<div class="form_bar">
							<div class="flied_outer flied_outer_b">
								<div class="sugget_left">
									...
									<?php /*?><div class="time_flied" id="back_account_flied" style="display:none">
										<div class="flied">
									...
									<div class="terms">
                                        ...
                                        <div class="squaredFour left">
										<?php /*?>	<input type="radio" value="credit_card" <?php if($_SESSION['shopcheck_gift']['checkout_method'] == 'credit_card') echo 'checked="checked"'; ?> id="twenty" class="credit_cards" name="checkout_method" /><?php */?>
									...
									<div class="time_flied" id="credit_card_flied" style="display:block">
										<div class="flied">
