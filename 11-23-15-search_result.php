			...
			<div class="item_check">
				...
				<div class="show_option">
					...
					if($view_pro)
					{
						...
						{
					?>
						<li onclick="get_product('<?php echo $product['proid']; ?>')"><img src="<?php get_image($product['image_code']); ?>" alt="<?php echo $product['pro_name']; ?>" width="92" height="92" id="countButton_<?php echo $product['proid']; ?>"/></li>
					<?php } } ?>	
					</ul>
				</div>
			</div>
