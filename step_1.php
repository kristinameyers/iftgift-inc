			...
			<div class="regs_form regs_form_b">
				<form method="post" id="myForm" action="<?php echo ru; ?>process/process_recipit.php" class="suggest_form">
					...
					<div class="flied cash_gift">
						...
						<input type="text" name="cash_amount" id="cash_amount"  <?php if($_SESSION['biz_rep_err']['cash_amount'] || $_SESSION['biz_rep_err']['errors']) { ?> class="hightlight" <?php } ?> placeholder="$0.00" value="<?php echo $_SESSION['biz_rep']['cash_amount'];?>" onkeypress="changecolor()" onclick="changetext();" on>
