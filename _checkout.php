							...
							<div class="flied_outer flied_outer_b">
								<div class="sugget_left">
									...
									<div class="terms">
										<div class="terms_inner_b">
											<div class="squaredFour left">
												<input type="radio" value="credit_card" <?php if($_SESSION['biz_gift']['checkout_method'] == 'credit_card') echo 'checked="checked"'; ?> id="twenty" class="credit_cards" name="checkout_method" />
									...
									<?php } ?>
									<?php if($payment_setting['payment_option'] == '1') { ?>
									<div class="time_flied" id="credit_card_flied" <?php if($_SESSION['stripe_error']){?>style="display:block"<?php } else { ?>style="display:none"<?php } ?>>
											<div class="flied">
